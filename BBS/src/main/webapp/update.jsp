                    ...
                    <tr>
                        <td style="text-align: left;">
                            <% 
                                ...
                                String targetFileName = bbs.getFileName();
                            ...
                            <% if (fileExists) { %>
                                <div style="margin-bottom: 10px;">
                                    첨부 파일 : 
                                    <a href="<%= request.getContextPath() %>/downloadAction?file=<%= java.net.URLEncoder.encode(targetFileName, "UTF-8") %>" 
                                       style="text-decoration: none; color: #007bff;">
                                       📎 <%= targetFileName %>
                                    </a>
                                </div>
                            <% } %>
                            <input type="file" class="form-control" name="file" style="max-width: 300px; height: 38px; padding: 5px;">
                        </td>
                    </tr>
                </tbody>
            </table>
